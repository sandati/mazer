<%-- 
    Document   : login
    Created on : 25 nov. 2024, 16:40:43
    Author     : yahaya
--%>
                ...
                <div class="col-lg-5 col-12">
                    <div id="auth-left">
                        ...
                        <div class="text-center mt-5 text-lg fs-4">
                            <p class="text-gray-600">Don't have an account? <a href="/mazer/register" class="font-bold">Sign
                                    up</a>.</p>
                            <p><a class="font-bold" href="/mazer/forgot-password">Forgot password?</a>.</p>
                        </div>
                    </div>
                </div>
